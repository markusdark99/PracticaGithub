...
public class Ejercicios {
	...
	//Imprime por consola n numrtod enteros aleatorios (es el ejercicio superior)
	//entre inferior y superior
	public int[] generaEstadisticaAparición(int n,int inferior,int superior){
		Random rnd = new Random();
	...
	public static void main(String[] args) {
		...
		//ejercicios.imprimeAleatorios(500,1,6);
		int[] listaAleatorio = ejercicios.generaListaAleatorios(10,1,5000);
		// factorial(5);
